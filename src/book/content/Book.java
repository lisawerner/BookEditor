...
import book.person.Society;
import book.time.Timeline;
import book.world.World;
...
public class Book extends SerializedObject {
	...
	private TableOfContent my_tableOfContent;
	...
	private Book() {
		...
		my_tableOfContent = new TableOfContent();
	...
	public TableOfContent getTableOfContent() {
		if(my_tableOfContent == null){my_tableOfContent = new TableOfContent();}
