...
public class World {
	...
	private void sortPlace() {
		...
		ArrayList<Place> parentPlaceList = (ArrayList<Place>) my_world
				.stream()
				.filter(place -> place.getParentRef() == null)
				.collect(Collectors.toList());
		ArrayList<Place> sortedParentList = (ArrayList<Place>) parentPlaceList
				.stream()
