...
public class ThemeList {
	...
	public final static Theme BLUE_PHOENIX_THEME = new Theme("Blue Phoenix", Color.WHITE, new Color(0,145,255),
	...
	public final static Theme TEQUILA_SUNRISE_THEME = new Theme("Tequila Sunrise", Color.WHITE, new Color(255,75,0),
	...
	public final static Theme A_DIFFERENT_WORLD_THEME = new Theme("A different World", Color.WHITE, new Color(172, 10, 10),
			Color.WHITE, new Color(165,50,0), Color.DARK_GRAY, Color.WHITE,
	...
	public final static Theme WHITE_MAGIC_THEME = new Theme("White Magic", Color.WHITE, new Color(60, 80, 80),
	...
	public static ArrayList<Theme> getThemes() {
		...
		completeList.add(BLUE_PHOENIX_THEME);
		completeList.add(TEQUILA_SUNRISE_THEME);
		completeList.add(A_DIFFERENT_WORLD_THEME);
		completeList.add(WHITE_MAGIC_THEME);
		return completeList;
	}
