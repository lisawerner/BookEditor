...
public class PrintPage extends Page {
	...
	public PrintPage() {
		...
		JLabel lblChapterSettings = new JLabel("You can change all Settings in 'Book-Settings' in the left navigation menu");
		...
		JLabel lblBookTitle = new JLabel("Printed Title of the Book: " + Book.getInstance().getTitle());
		panel_hint.add(lblBookTitle);
		JLabel lblTitleSettings = new JLabel("Warning: Title is not set yet! It is only a work title!");
		if(Book.getInstance().isWorkTitle()) {panel_hint.add(lblTitleSettings);}
		lblTitleSettings.setForeground(Color.RED);
		JLabel lblChapter = new JLabel("Chapters will printed with numbers as chapter-title");
		...
		JLabel lblSectionless = new JLabel("Warning: You have no Sections and no Text!");
		...
		JLabel lblSectionUnfinished = new JLabel("Warning: You have Sections, which are not finished! Filter for Sections with DevelopmentStatus != Finish");
		...
		JLabel lblSectionsEmpty = new JLabel("Warning: You have Sections, which have no text! Filter for Sections without text");
		...
		JLabel lblSectionsUnsorted = new JLabel("Warning: You have Sections, which are not sorted inside table of content! Filter for these unsorted Sections");
